...
void PWM_R_Stop(void) 
{
    ...
    *******************************************************************************/
    ...
    {
        CY_SET_REG16(PWM_R_COUNTER_LSB_PTR, counter);
    }
    ...
    *******************************************************************************/
    uint16 PWM_R_ReadCounter(void) 
    {
        ...
        return (CY_GET_REG16(PWM_R_CAPTURE_LSB_PTR));
    }
...
void PWM_R_WritePeriod(uint16 period) 
{
    ...
    #else
        CY_SET_REG16(PWM_R_PERIOD_LSB_PTR, period);
    #endif /* (PWM_R_UsingFixedFunction) */
}
    ...
    *******************************************************************************/
                                       ...
                                       
    {
        ...
        #else
            CY_SET_REG16(PWM_R_COMPARE1_LSB_PTR, compare);
        #endif /* (PWM_R_UsingFixedFunction) */
            ...
            #else
                CY_SET_REG16(PWM_R_COMPARE2_LSB_PTR, (compare + 1u));
            #endif /* (PWM_R_UsingFixedFunction) */
    ...
    *******************************************************************************/
    ...
    {
        #if(PWM_R_UsingFixedFunction)
            return ((uint16)CY_GET_REG16(PWM_R_COMPARE1_LSB_PTR));
        #else
            return (CY_GET_REG16(PWM_R_COMPARE1_LSB_PTR));
        #endif /* (PWM_R_UsingFixedFunction) */
    }
    ...
    *******************************************************************************/
    ...
    {
        return (CY_GET_REG16(PWM_R_COMPARE2_LSB_PTR));
    }
...
{
    #if(PWM_R_UsingFixedFunction)
        return ((uint16)CY_GET_REG16(PWM_R_PERIOD_LSB_PTR));
    #else
        return (CY_GET_REG16(PWM_R_PERIOD_LSB_PTR));
    #endif /* (PWM_R_UsingFixedFunction) */
}
